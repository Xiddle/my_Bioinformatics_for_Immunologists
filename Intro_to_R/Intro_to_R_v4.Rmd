...
This tutorial is based on the two tutorials (tutorial-1 , tutorial-2 , <https://www.w3schools.com/r/r_graph_plot.asp>). \## CREDIT
...
```{r}
# 10 = z # incorrect assignment
```

See all R objects that you have defined so far
...
Remove all variables in your workspace
...
-   Sales, Profit, Expenses: These numbers are adjusted to not end with 0 and to have varying digits, maintaining moderate correlation while avoiding too even patterns.
